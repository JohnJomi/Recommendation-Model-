      ...
      <main className={`min-h-screen transition-colors duration-300 ${
        ...
        <div className="flex items-center justify-center min-h-96 pt-24">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className={isDarkMode ? "text-gray-400" : "text-amber-800/70"}>Loading...</p>
          </div>
        </div>
      </main>
    )
  ...
  return (
    <main className={`min-h-screen transition-colors duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-8 pt-24 pb-16">
        <h1 className={`text-5xl font-bold mb-4 ${isDarkMode ? "text-white" : "text-amber-950"}`}>AI Recommendations</h1>
        <p className={`text-lg ${isDarkMode ? "text-gray-400" : "text-amber-800/70"}`}>Coming soon...</p>
      </div>
    </main>
  )
}
